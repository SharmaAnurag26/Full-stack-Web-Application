async function fetchOpenEnquiries() {
    const openEnquiriesElement = document.getElementById("openEnquiriesCount");
    if (!openEnquiriesElement) {
        console.error("Element with ID 'openEnquiriesCount' not found.");
        return;
    }
    ...
    try {
        const response = await fetch('http://127.0.0.1:5000/open-enquiries'); // Replace with your actual backend URL
